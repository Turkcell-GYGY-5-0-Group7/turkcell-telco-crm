package com.telco.payment.application;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.telco.payment.domain.AuditLog;
import com.telco.payment.infrastructure.persistence.AuditLogRepository;
...
public class AuditLogWriter {
     ...
     * its own.
     *
     * @param action   action code, e.g. {@code "PAYMENT_COMPLETED"}
     * @param entity   entity type name, e.g. {@code "Payment"}
