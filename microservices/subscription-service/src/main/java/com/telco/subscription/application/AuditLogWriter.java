...
import com.telco.subscription.infrastructure.AuditLogRepository;
...
public class AuditLogWriter {
     ...
     * its own.
     *
     * @param action   action code, e.g. {@code "SUBSCRIPTION_ACTIVATED"}
     * @param entity   entity type name, e.g. {@code "Subscription"}
