package com.telco.customer.persistence;
...
class CustomerRepositoryTest {
    ...
    void softDeleteExcludesFromDefaultReadsButRetainsTheRow() {
        ...
        // Sanity: present before deletion.
        ...
        // Excluded from default reads (the @SQLRestriction filter).
        assertThat(customers.findById(id)).isEmpty();

        // But the row persists with deleted_at set (native query bypasses the filter).
    ...
    void identityNumberIsStoredAsCiphertextNotPlaintext() {
        ...
        // Decrypts back to plaintext through the converter on read.
