package com.telco.identity.application;
...
public class AuditLogWriter {
     ...
     * @param entity   entity type name, e.g. {@code "User"}
     * @param entityId string representation of the entity's primary key; may be null
     * @param details  arbitrary key-value pairs serialized to JSON; may be null
     */
