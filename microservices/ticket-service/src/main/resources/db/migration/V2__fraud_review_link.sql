-- Fraud-case linkage + fraud-review SLA (Sprint 23 Feature 23.4.2)
--
...
-- the fraud case. Generic nullable column (not fraud-specific) so the same field also serves the
-- ADR-028 dispute -> ticket linkage pattern.
ALTER TABLE tickets ADD COLUMN external_ref VARCHAR(100);
