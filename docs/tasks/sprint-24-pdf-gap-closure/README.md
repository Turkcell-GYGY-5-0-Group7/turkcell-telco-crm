...
| 24.5 | Customer contact info + type-conditional TCKN/VKN validation | TODO | [24.5-customer-contact-and-conditional-id-validation.md](24.5-customer-contact-and-conditional-id-validation.md) |
| 24.6 | Payment method + Idempotency-Key header | TODO | [24.6-payment-method-and-idempotency-header.md](24.6-payment-method-and-idempotency-header.md) |
