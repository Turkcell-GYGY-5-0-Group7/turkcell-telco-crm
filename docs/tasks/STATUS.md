...
| [24](sprint-24-pdf-gap-closure/README.md) | MVP-spec gap closure: addon/plan-change orders, addon billing, contact info, payment method, Swagger/API polish | IN PROGRESS | 7/8 (24.8 live run done; blocked by a pre-existing consumer-retry defect, see sprint-24 run report) |
