...
Last updated: 2026-06-26 (Sprint 06 DONE — all 4/4 features complete, including 6.4 integration tests + schema-compat gate)
...
Totals (MVP, Sprints 01-15): 6 sprints DONE, 0 IN PROGRESS, 9 TODO. Features: 29 DONE / 0 IN PROGRESS
/ 46 TODO (75 total). Sprint 16 is post-MVP (ADR-022) and excluded from the MVP totals.
