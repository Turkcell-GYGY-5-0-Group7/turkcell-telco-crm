...
**DONE 5/5** - see the 2026-07-12 entries above; Sprints 18-19 and 21-23: ADR-025 through ADR-029,
all Proposed pending tech-lead ratification; Sprint 20: extends ADR-012/ADR-013, no new ADR) and
excluded from the MVP totals. Sprint 17 is complete; the other 7 remain documentation/design only as
of 2026-07-11 - TODO, not started. See Phase P6 below and
