...
| [24](sprint-24-pdf-gap-closure/README.md) | MVP-spec gap closure: addon/plan-change orders, addon billing, contact info, payment method, Swagger/API polish | IN PROGRESS | 2/8 |
