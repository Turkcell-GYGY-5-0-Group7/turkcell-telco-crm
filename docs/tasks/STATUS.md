...
Last updated: 2026-06-25 (Sprint 05 feature 5.1 DONE)
...
| [05](sprint-05-security-and-identity/README.md) | identity-service, JWT, RBAC | IN PROGRESS | 1/7 |
...
Totals (MVP, Sprints 01-15): 4 sprints DONE, 1 IN PROGRESS, 10 TODO. Features: 18 DONE / 0 IN PROGRESS
/ 57 TODO (75 total). Sprint 16 is post-MVP (ADR-022) and excluded from the MVP totals.
